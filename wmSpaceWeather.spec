...
dla 2 przedzia³ów energii) oraz warto¶ci strumienia relatywistycznych
protonów (oddzielnie dla 3 przedzia³ów energii) mierzonego na orbicie
geosynchronicznej (aktualnie sond± NOAA GEOS), aktualne strumienie
promieniowania rentgenowskiego z wiatru s³onecznego oraz ostatnie 8
